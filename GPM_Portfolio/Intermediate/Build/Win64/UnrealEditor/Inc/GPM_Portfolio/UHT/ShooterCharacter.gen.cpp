...
GPM_PORTFOLIO_API UClass* Z_Construct_UClass_AShooterCharacter();
GPM_PORTFOLIO_API UClass* Z_Construct_UClass_AShooterCharacter_NoRegister();
GPM_PORTFOLIO_API UClass* Z_Construct_UClass_UShooterWeaponHolder_NoRegister();
...
struct Z_Construct_UDelegateFunction_GPM_Portfolio_BulletCountUpdatedDelegate__DelegateSignature_Statics
{
	struct _Script_GPM_Portfolio_eventBulletCountUpdatedDelegate_Parms
	{
		int32 MagazineSize;
		int32 Bullets;
	};
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UDelegateFunction_GPM_Portfolio_BulletCountUpdatedDelegate__DelegateSignature_Statics::NewProp_MagazineSize = { "MagazineSize", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_GPM_Portfolio_eventBulletCountUpdatedDelegate_Parms, MagazineSize), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UDelegateFunction_GPM_Portfolio_BulletCountUpdatedDelegate__DelegateSignature_Statics::NewProp_Bullets = { "Bullets", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_GPM_Portfolio_eventBulletCountUpdatedDelegate_Parms, Bullets), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_GPM_Portfolio_BulletCountUpdatedDelegate__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_GPM_Portfolio_BulletCountUpdatedDelegate__DelegateSignature_Statics::NewProp_MagazineSize,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_GPM_Portfolio_BulletCountUpdatedDelegate__DelegateSignature_Statics::NewProp_Bullets,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_GPM_Portfolio_BulletCountUpdatedDelegate__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_GPM_Portfolio_BulletCountUpdatedDelegate__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_GPM_Portfolio, nullptr, "BulletCountUpdatedDelegate__DelegateSignature", Z_Construct_UDelegateFunction_GPM_Portfolio_BulletCountUpdatedDelegate__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_GPM_Portfolio_BulletCountUpdatedDelegate__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_GPM_Portfolio_BulletCountUpdatedDelegate__DelegateSignature_Statics::_Script_GPM_Portfolio_eventBulletCountUpdatedDelegate_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_GPM_Portfolio_BulletCountUpdatedDelegate__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_GPM_Portfolio_BulletCountUpdatedDelegate__DelegateSignature_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UDelegateFunction_GPM_Portfolio_BulletCountUpdatedDelegate__DelegateSignature_Statics::_Script_GPM_Portfolio_eventBulletCountUpdatedDelegate_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_GPM_Portfolio_BulletCountUpdatedDelegate__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_GPM_Portfolio_BulletCountUpdatedDelegate__DelegateSignature_Statics::FuncParams);
	}
...
void FBulletCountUpdatedDelegate_DelegateWrapper(const FMulticastScriptDelegate& BulletCountUpdatedDelegate, int32 MagazineSize, int32 Bullets)
{
	...
	_Script_GPM_Portfolio_eventBulletCountUpdatedDelegate_Parms Parms;
...
struct Z_Construct_UDelegateFunction_GPM_Portfolio_DamagedDelegate__DelegateSignature_Statics
{
	struct _Script_GPM_Portfolio_eventDamagedDelegate_Parms
	{
		float LifePercent;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UDelegateFunction_GPM_Portfolio_DamagedDelegate__DelegateSignature_Statics::NewProp_LifePercent = { "LifePercent", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_GPM_Portfolio_eventDamagedDelegate_Parms, LifePercent), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_GPM_Portfolio_DamagedDelegate__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_GPM_Portfolio_DamagedDelegate__DelegateSignature_Statics::NewProp_LifePercent,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_GPM_Portfolio_DamagedDelegate__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_GPM_Portfolio_DamagedDelegate__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_GPM_Portfolio, nullptr, "DamagedDelegate__DelegateSignature", Z_Construct_UDelegateFunction_GPM_Portfolio_DamagedDelegate__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_GPM_Portfolio_DamagedDelegate__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_GPM_Portfolio_DamagedDelegate__DelegateSignature_Statics::_Script_GPM_Portfolio_eventDamagedDelegate_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_GPM_Portfolio_DamagedDelegate__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_GPM_Portfolio_DamagedDelegate__DelegateSignature_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UDelegateFunction_GPM_Portfolio_DamagedDelegate__DelegateSignature_Statics::_Script_GPM_Portfolio_eventDamagedDelegate_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_GPM_Portfolio_DamagedDelegate__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_GPM_Portfolio_DamagedDelegate__DelegateSignature_Statics::FuncParams);
	}
	return ReturnFunction;
}
void FDamagedDelegate_DelegateWrapper(const FMulticastScriptDelegate& DamagedDelegate, float LifePercent)
{
	...
	_Script_GPM_Portfolio_eventDamagedDelegate_Parms Parms;
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_AShooterCharacter_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UShooterWeaponHolder_NoRegister, (int32)VTABLE_OFFSET(AShooterCharacter, IShooterWeaponHolder), false },  // 1668388751
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_lotti_OneDrive___MMU_Documents_GitHub_mgp_ljh1246_GPM_Portfolio_Source_GPM_Portfolio_Variant_Shooter_ShooterCharacter_h__Script_GPM_Portfolio_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AShooterCharacter, AShooterCharacter::StaticClass, TEXT("AShooterCharacter"), &Z_Registration_Info_UClass_AShooterCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AShooterCharacter), 867069655U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_lotti_OneDrive___MMU_Documents_GitHub_mgp_ljh1246_GPM_Portfolio_Source_GPM_Portfolio_Variant_Shooter_ShooterCharacter_h__Script_GPM_Portfolio_145239026(TEXT("/Script/GPM_Portfolio"),
	Z_CompiledInDeferFile_FID_Users_lotti_OneDrive___MMU_Documents_GitHub_mgp_ljh1246_GPM_Portfolio_Source_GPM_Portfolio_Variant_Shooter_ShooterCharacter_h__Script_GPM_Portfolio_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_lotti_OneDrive___MMU_Documents_GitHub_mgp_ljh1246_GPM_Portfolio_Source_GPM_Portfolio_Variant_Shooter_ShooterCharacter_h__Script_GPM_Portfolio_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
