...
GPM_PORTFOLIO_API UClass* Z_Construct_UClass_AHorrorCharacter();
GPM_PORTFOLIO_API UClass* Z_Construct_UClass_AHorrorCharacter_NoRegister();
...
struct Z_Construct_UDelegateFunction_GPM_Portfolio_UpdateSprintMeterDelegate__DelegateSignature_Statics
{
	struct _Script_GPM_Portfolio_eventUpdateSprintMeterDelegate_Parms
	{
		float Percentage;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UDelegateFunction_GPM_Portfolio_UpdateSprintMeterDelegate__DelegateSignature_Statics::NewProp_Percentage = { "Percentage", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_GPM_Portfolio_eventUpdateSprintMeterDelegate_Parms, Percentage), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_GPM_Portfolio_UpdateSprintMeterDelegate__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_GPM_Portfolio_UpdateSprintMeterDelegate__DelegateSignature_Statics::NewProp_Percentage,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_GPM_Portfolio_UpdateSprintMeterDelegate__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_GPM_Portfolio_UpdateSprintMeterDelegate__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_GPM_Portfolio, nullptr, "UpdateSprintMeterDelegate__DelegateSignature", Z_Construct_UDelegateFunction_GPM_Portfolio_UpdateSprintMeterDelegate__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_GPM_Portfolio_UpdateSprintMeterDelegate__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_GPM_Portfolio_UpdateSprintMeterDelegate__DelegateSignature_Statics::_Script_GPM_Portfolio_eventUpdateSprintMeterDelegate_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_GPM_Portfolio_UpdateSprintMeterDelegate__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_GPM_Portfolio_UpdateSprintMeterDelegate__DelegateSignature_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UDelegateFunction_GPM_Portfolio_UpdateSprintMeterDelegate__DelegateSignature_Statics::_Script_GPM_Portfolio_eventUpdateSprintMeterDelegate_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_GPM_Portfolio_UpdateSprintMeterDelegate__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_GPM_Portfolio_UpdateSprintMeterDelegate__DelegateSignature_Statics::FuncParams);
	}
...
void FUpdateSprintMeterDelegate_DelegateWrapper(const FMulticastScriptDelegate& UpdateSprintMeterDelegate, float Percentage)
{
	...
	_Script_GPM_Portfolio_eventUpdateSprintMeterDelegate_Parms Parms;
...
struct Z_Construct_UDelegateFunction_GPM_Portfolio_SprintStateChangedDelegate__DelegateSignature_Statics
{
	struct _Script_GPM_Portfolio_eventSprintStateChangedDelegate_Parms
	{
		bool bSprinting;
	};
#if WITH_METADATA
...
void Z_Construct_UDelegateFunction_GPM_Portfolio_SprintStateChangedDelegate__DelegateSignature_Statics::NewProp_bSprinting_SetBit(void* Obj)
{
	((_Script_GPM_Portfolio_eventSprintStateChangedDelegate_Parms*)Obj)->bSprinting = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UDelegateFunction_GPM_Portfolio_SprintStateChangedDelegate__DelegateSignature_Statics::NewProp_bSprinting = { "bSprinting", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(_Script_GPM_Portfolio_eventSprintStateChangedDelegate_Parms), &Z_Construct_UDelegateFunction_GPM_Portfolio_SprintStateChangedDelegate__DelegateSignature_Statics::NewProp_bSprinting_SetBit, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_GPM_Portfolio_SprintStateChangedDelegate__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_GPM_Portfolio_SprintStateChangedDelegate__DelegateSignature_Statics::NewProp_bSprinting,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_GPM_Portfolio_SprintStateChangedDelegate__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_GPM_Portfolio_SprintStateChangedDelegate__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_GPM_Portfolio, nullptr, "SprintStateChangedDelegate__DelegateSignature", Z_Construct_UDelegateFunction_GPM_Portfolio_SprintStateChangedDelegate__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_GPM_Portfolio_SprintStateChangedDelegate__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_GPM_Portfolio_SprintStateChangedDelegate__DelegateSignature_Statics::_Script_GPM_Portfolio_eventSprintStateChangedDelegate_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_GPM_Portfolio_SprintStateChangedDelegate__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_GPM_Portfolio_SprintStateChangedDelegate__DelegateSignature_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UDelegateFunction_GPM_Portfolio_SprintStateChangedDelegate__DelegateSignature_Statics::_Script_GPM_Portfolio_eventSprintStateChangedDelegate_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_GPM_Portfolio_SprintStateChangedDelegate__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_GPM_Portfolio_SprintStateChangedDelegate__DelegateSignature_Statics::FuncParams);
	}
	return ReturnFunction;
}
void FSprintStateChangedDelegate_DelegateWrapper(const FMulticastScriptDelegate& SprintStateChangedDelegate, bool bSprinting)
{
	...
	_Script_GPM_Portfolio_eventSprintStateChangedDelegate_Parms Parms;
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_lotti_OneDrive___MMU_Documents_GitHub_mgp_ljh1246_GPM_Portfolio_Source_GPM_Portfolio_Variant_Horror_HorrorCharacter_h__Script_GPM_Portfolio_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AHorrorCharacter, AHorrorCharacter::StaticClass, TEXT("AHorrorCharacter"), &Z_Registration_Info_UClass_AHorrorCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AHorrorCharacter), 882549052U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_lotti_OneDrive___MMU_Documents_GitHub_mgp_ljh1246_GPM_Portfolio_Source_GPM_Portfolio_Variant_Horror_HorrorCharacter_h__Script_GPM_Portfolio_2580800336(TEXT("/Script/GPM_Portfolio"),
	Z_CompiledInDeferFile_FID_Users_lotti_OneDrive___MMU_Documents_GitHub_mgp_ljh1246_GPM_Portfolio_Source_GPM_Portfolio_Variant_Horror_HorrorCharacter_h__Script_GPM_Portfolio_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_lotti_OneDrive___MMU_Documents_GitHub_mgp_ljh1246_GPM_Portfolio_Source_GPM_Portfolio_Variant_Horror_HorrorCharacter_h__Script_GPM_Portfolio_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
