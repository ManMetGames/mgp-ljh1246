...
GPM_PORTFOLIO_API UClass* Z_Construct_UClass_AShooterNPC();
GPM_PORTFOLIO_API UClass* Z_Construct_UClass_AShooterNPC_NoRegister();
GPM_PORTFOLIO_API UClass* Z_Construct_UClass_AShooterWeapon_NoRegister();
...
struct Z_Construct_UDelegateFunction_GPM_Portfolio_PawnDeathDelegate__DelegateSignature_Statics
{
#if WITH_METADATA
...
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_GPM_Portfolio_PawnDeathDelegate__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_GPM_Portfolio, nullptr, "PawnDeathDelegate__DelegateSignature", nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_GPM_Portfolio_PawnDeathDelegate__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_GPM_Portfolio_PawnDeathDelegate__DelegateSignature_Statics::Function_MetaDataParams)},  };
UFunction* Z_Construct_UDelegateFunction_GPM_Portfolio_PawnDeathDelegate__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_GPM_Portfolio_PawnDeathDelegate__DelegateSignature_Statics::FuncParams);
	}
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_AShooterNPC_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UShooterWeaponHolder_NoRegister, (int32)VTABLE_OFFSET(AShooterNPC, IShooterWeaponHolder), false },  // 1668388751
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_lotti_OneDrive___MMU_Documents_GitHub_mgp_ljh1246_GPM_Portfolio_Source_GPM_Portfolio_Variant_Shooter_AI_ShooterNPC_h__Script_GPM_Portfolio_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AShooterNPC, AShooterNPC::StaticClass, TEXT("AShooterNPC"), &Z_Registration_Info_UClass_AShooterNPC, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AShooterNPC), 2845245526U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_lotti_OneDrive___MMU_Documents_GitHub_mgp_ljh1246_GPM_Portfolio_Source_GPM_Portfolio_Variant_Shooter_AI_ShooterNPC_h__Script_GPM_Portfolio_3651663831(TEXT("/Script/GPM_Portfolio"),
	Z_CompiledInDeferFile_FID_Users_lotti_OneDrive___MMU_Documents_GitHub_mgp_ljh1246_GPM_Portfolio_Source_GPM_Portfolio_Variant_Shooter_AI_ShooterNPC_h__Script_GPM_Portfolio_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_lotti_OneDrive___MMU_Documents_GitHub_mgp_ljh1246_GPM_Portfolio_Source_GPM_Portfolio_Variant_Shooter_AI_ShooterNPC_h__Script_GPM_Portfolio_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
